...
export class PopupHeader extends LitElement {
  ...
  render() {
    return html`
      <h2>${brw.i18n.getMessage("extName")}</h2>
  ...
  render() {
    ...
    return html`
      <div>
        ...
        <h2 style="color: ${this.results.countVisible ? "yellow" : "aqua"}">
...
export class PopupFooter extends LitElement {
  ...
  render() {
    return html`
      <div>
        ${brw.i18n.getMessage("feedbackMoreInformation")}:
        <button
          style="padding: 10px; background-color: #910707; border: none; text-decoration: none; cursor: pointer;"
        >
          <a
