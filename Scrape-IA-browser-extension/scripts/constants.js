...
export const patternConfig = {
  patterns: [
    ...
    },
    {
       ...
       * You can watch as the desired good slips away.
       */
      name: brw.i18n.getMessage("patternBasketSneaking_name"),
      className: "basket-sneaking",
      detectionFunctions: [
        function (node, nodeOld) {
          return false;
        },
      ],
      infoUrl: brw.i18n.getMessage("patternBasketSneaking_infoUrl"),
      info: brw.i18n.getMessage("patternBasketSneaking_info"),
      languages: ["en", "de"],
    },
  ],
};
